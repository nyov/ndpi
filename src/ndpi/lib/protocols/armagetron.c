					       ...
					       struct ndpi_flow_struct *flow)
{
  ...
  ndpi_int_add_connection(ndpi_struct, flow, NDPI_OLD_RESULT_APP_ARMAGETRON, NDPI_REAL_PROTOCOL);
}
...
void ndpi_search_armagetron_udp(struct ndpi_detection_module_struct *ndpi_struct, struct ndpi_flow_struct *flow)
{
  ...
  NDPI_LOG(NDPI_OLD_RESULT_APP_ARMAGETRON, ndpi_struct, NDPI_LOG_DEBUG, "search armagetron.\n");
  ...
  if (packet->payload_packet_len > 10) {
	...
	NDPI_LOG(NDPI_OLD_RESULT_APP_ARMAGETRON, ndpi_struct, NDPI_LOG_DEBUG, "detected armagetron.\n");
 ...
 exclude:
  NDPI_LOG(NDPI_OLD_RESULT_APP_ARMAGETRON, ndpi_struct, NDPI_LOG_DEBUG, "exclude armagetron.\n");
  NDPI_ADD_PROTOCOL_TO_BITMASK(flow->excluded_protocol_bitmask, NDPI_OLD_RESULT_APP_ARMAGETRON);
}
