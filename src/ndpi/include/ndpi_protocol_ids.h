...
typedef enum {
  NDPI_RESULT_CDN_STILL_UNKNOWN,
  NDPI_RESULT_CDN_UNKNOWN,
  NDPI_RESULT_CDN_FACEBOOK,
  NDPI_RESULT_CDN_TWITTER,
  NDPI_RESULT_CDN_YOUTUBE,
  NDPI_RESULT_CDN_GOOGLE,
  NDPI_RESULT_CDN_NETFLIX,
  NDPI_RESULT_CDN_LASTFM,
  NDPI_RESULT_CDN_GROOVESHARK,
  NDPI_RESULT_CDN_APPLE,
  NDPI_RESULT_CDN_WHATSAPP,
  NDPI_RESULT_CDN_APPLE_ICLOUD,
  NDPI_RESULT_CDN_APPLE_ITUNES,
  NDPI_RESULT_CDN_TUENTI,
  NDPI_RESULT_CDN_WIKIPEDIA,
  NDPI_RESULT_CDN_MSN,
  NDPI_RESULT_CDN_AMAZON,
  NDPI_RESULT_CDN_EBAY,
  NDPI_RESULT_CDN_CNN,
  NDPI_RESULT_CDN_DROPBOX,
  NDPI_RESULT_CDN_SKYPE,
  NDPI_RESULT_CDN_VIBER,
  NDPI_RESULT_CDN_YAHOO,
  NDPI_RESULT_CDN_LAST
} ndpi_result_cdn_t;
