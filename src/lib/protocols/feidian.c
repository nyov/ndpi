...
static void ndpi_int_feidian_add_connection(struct ndpi_detection_module_struct
											  *ndpi_struct, ndpi_protocol_type_t protocol_type)
{
	ndpi_int_add_connection(ndpi_struct, NDPI_PROTOCOL_FEIDIAN, protocol_type);
}


void ndpi_search_feidian(struct ndpi_detection_module_struct *ndpi_struct)
{
