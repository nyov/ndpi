...
void ndpi_search_skinny(struct ndpi_detection_module_struct *ndpi_struct, struct ndpi_flow_struct *flow)
{
  ...
  static const char pattern_9_bytes[9] = { 0x24, 0x00, 0x00, 0x00, 0x00,
					   0x00, 0x00, 0x00, 0x00
  };
  static const char pattern_8_bytes[8] = { 0x38, 0x00, 0x00, 0x00, 0x00,
					   0x00, 0x00, 0x00
  };
  static const char keypadmsg_8_bytes[8] = { 0x10, 0x00, 0x00, 0x00, 0x00,
					     0x00, 0x00, 0x00
  };
  static const char selectmsg_8_bytes[8] = { 0x14, 0x00, 0x00, 0x00, 0x00,
					     0x00, 0x00, 0x00
  };
  if(packet->tcp != NULL) {
